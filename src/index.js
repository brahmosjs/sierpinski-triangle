/**
 * Src: https://github.com/facebook/react/blob/master/fixtures/fiber-triangle/index.html
 */
...
class Dot extends Brahmos.Component {
  constructor() {
    super();
...
class SierpinskiTriangle extends Brahmos.Component {
...
class ExampleApplication extends Brahmos.Component {
  constructor() {
    super();
    this.state = {
      seconds: 0,
  ...
  render() {
    ...
    return (
      <div>
        <div>
          <h2>Brahmos Time-slicing Demo</h2>
...
class Toggle extends Brahmos.Component {
  constructor(props) {
    super();
